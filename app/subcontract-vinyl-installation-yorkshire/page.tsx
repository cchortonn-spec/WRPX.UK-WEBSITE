        ...
        <div className="container mx-auto max-w-4xl">
          <div className="card-float p-8 md:p-10">
            ...
            <div className="mt-6 flex flex-wrap gap-3 text-sm">
              ...
              <Link
                href="/subcontract-vinyl-installer-mansfield/"
                className="text-accent hover:underline"
              >
                Subcontract installer — Mansfield
              </Link>
              <Link
                href="/subcontract-vinyl-installer-derby/"
                className="text-accent hover:underline"
              >
                Subcontract installer — Derby
              </Link>
              <Link
              ...
              <Link
                href="/subcontract-vinyl-installer-newark/"
                className="text-accent hover:underline"
              >
                Subcontract installer — Newark
              </Link>
              <Link
                href="/subcontract-vinyl-installer-grimsby/"
                className="text-accent hover:underline"
              >
              ...
              <Link
                href="/subcontract-vinyl-installer-manchester/"
                className="text-accent hover:underline"
              >
                Subcontract installer — Manchester
              </Link>
              <Link
                href="/subcontract-vinyl-installer-preston/"
                className="text-accent hover:underline"
              >
              ...
              <Link
                href="/subcontract-vinyl-installer-chester/"
                className="text-accent hover:underline"
              >
                Subcontract installer — Chester
              </Link>
              <Link
                href="/subcontract-vinyl-installer-wigan/"
                className="text-accent hover:underline"
              >
                Subcontract installer — Wigan
              </Link>
              <Link
                href="/subcontract-vinyl-installer-bolton/"
                className="text-accent hover:underline"
              >
                Subcontract installer — Bolton
              </Link>
              <Link
                href="/subcontract-vinyl-installer-burnley/"
                className="text-accent hover:underline"
              >
                Subcontract installer — Burnley &amp; East Lancs
              </Link>
              <Link
