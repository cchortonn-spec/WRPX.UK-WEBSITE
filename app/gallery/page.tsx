...
const galleryItems = [
  // Navy wood-effect + white marble kitchen wrap — Doncaster
  { src: "/images/Kitchen-navy-marble-doncaster/navy-marble-kitchen-wrap-doncaster-after-01.jpeg", alt: "Navy wood-effect kitchen wrap Doncaster — full kitchen with white marble worktop after", caption: "Navy marble kitchen wrap, Doncaster", projectLine: "Navy wood-effect wrap with white marble high-gloss worktop, Doncaster" },
  { src: "/images/Kitchen-navy-marble-doncaster/navy-marble-kitchen-wrap-doncaster-after-02.jpeg", alt: "Navy wood-effect kitchen wrap Doncaster — L-shaped kitchen with marble splashback after", caption: "Full kitchen view, Doncaster", projectLine: "Completed navy and marble kitchen wrap, Doncaster" },
  { src: "/images/Kitchen-navy-marble-doncaster/navy-marble-kitchen-wrap-doncaster-after-03.jpeg", alt: "Navy kitchen wrap Doncaster — sink run with brass tap and white marble worktop after", caption: "Sink run, Doncaster", projectLine: "Navy cabinets with white marble worktop and splashback, Doncaster" },
  { src: "/images/Kitchen-navy-marble-doncaster/navy-marble-kitchen-wrap-doncaster-after-04.jpeg", alt: "Navy wood-effect kitchen wrap Doncaster — worktop and oven area after", caption: "Worktop and oven, Doncaster", projectLine: "White marble worktop wrap with navy wood-effect doors, Doncaster" },
  { src: "/images/Kitchen-navy-marble-doncaster/navy-marble-kitchen-wrap-doncaster-after-05.jpeg", alt: "Navy kitchen wrap Doncaster — angled view of marble worktop and navy cabinets after", caption: "Angled kitchen view, Doncaster", projectLine: "Navy wood-effect and marble kitchen transformation, Doncaster" },
  { src: "/images/Kitchen-navy-marble-doncaster/navy-marble-kitchen-wrap-doncaster-worktop-detail-01.jpeg", alt: "White marble high-gloss worktop wrap Doncaster — close-up surface detail", caption: "Marble worktop detail, Doncaster", projectLine: "High-gloss white marble-effect vinyl worktop close-up, Doncaster" },
  { src: "/images/Kitchen-navy-marble-doncaster/navy-marble-kitchen-wrap-doncaster-splashback-detail-01.jpeg", alt: "White marble splashback and upstand wrap Doncaster — finish detail", caption: "Marble splashback detail, Doncaster", projectLine: "Marble-effect upstand and splashback wrap finish, Doncaster" },
  { src: "/images/Kitchen-navy-marble-doncaster/navy-marble-kitchen-wrap-doncaster-before-01.jpeg", alt: "Kitchen wrap Doncaster before — grey gloss kitchen before navy marble transformation", caption: "Before — grey kitchen, Doncaster", projectLine: "Original grey gloss kitchen before navy wood-effect wrap, Doncaster" },
  { src: "/images/Kitchen-navy-marble-doncaster/navy-marble-kitchen-wrap-doncaster-before-02.jpeg", alt: "Kitchen wrap Doncaster before — grey base cabinets and dark worktop", caption: "Before — base cabinets, Doncaster", projectLine: "Original kitchen cabinets before vinyl wrap, Doncaster" },
  { src: "/images/Kitchen-navy-marble-doncaster/navy-marble-kitchen-wrap-doncaster-before-03.jpeg", alt: "Kitchen wrap Doncaster before — grey drawer fronts and dark marble worktop", caption: "Before — drawer detail, Doncaster", projectLine: "Original grey kitchen before transformation, Doncaster" },
