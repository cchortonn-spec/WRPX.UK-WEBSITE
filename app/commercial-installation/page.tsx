      ...
      <section className="border-y border-border bg-card px-4 py-12">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="mt-6 flex flex-wrap gap-3 text-sm">
            ...
            <Link href="/subcontract-vinyl-installer-manchester/" className="text-accent hover:underline">
              Subcontract installer Manchester
            </Link>
            <Link href="/subcontract-vinyl-installer-preston/" className="text-accent hover:underline">
              Subcontract installer Preston &amp; Lancashire
            </Link>
            <Link href="/subcontract-vinyl-installer-liverpool/" className="text-accent hover:underline">
              Subcontract installer Liverpool &amp; Merseyside
            </Link>
            ...
            <Link href="/subcontract-vinyl-installer-bolton/" className="text-accent hover:underline">
              Subcontract installer Bolton &amp; Greater Manchester North
            </Link>
            <Link href="/subcontract-vinyl-installer-burnley/" className="text-accent hover:underline">
              Subcontract installer Burnley &amp; East Lancashire
            </Link>
          </div>
        </div>
      </section>
